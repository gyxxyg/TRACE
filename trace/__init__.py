...
from .model import TraceMistralForCausalLM
...
def model_init(model_path=None):
    model_path = "DAMO-NLP-SG/Trace-7B" if model_path is None else model_path
...
def infer(model, video, instruct, tokenizer, do_sample=False):
    """inference api of Trace for video understanding.
