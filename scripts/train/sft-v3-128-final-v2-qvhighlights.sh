...
ASCEND_LAUNCH_BLOCKING=1 torchrun --nnodes $WORLD_SIZE \
    ...
    --data_path yourpath/data/VTG-MD-IT/video_highlight_detection/QVHighlights/mt_fmt-8k.json \
    --data_folder data/ \
    ...
    --tf32 False \
    --fp16 False \
    --output_dir ${OUTP_DIR}/${WANDB_PROJECT}/sft_v3_128_v4_sep_final_v3_qvhighlights_8k_v2 \
    --num_train_epochs 40 \
    ...
    --sample_scheme "rand" \
    2> ${OUTP_DIR}/${WANDB_PROJECT}/log_128_sep_final_v2_qvhighlights_8k.err
