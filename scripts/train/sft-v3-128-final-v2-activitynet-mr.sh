...
ASCEND_LAUNCH_BLOCKING=1 torchrun --nnodes $WORLD_SIZE \
    ...
    --data_path yourpath/data/VTG-MD-IT/dense_video_caption/ActivityNet_Captions/mr_fmt_mt_ft.json \
    --data_folder data/ \
    ...
    --tf32 False \
    --fp16 False \
    --output_dir ${OUTP_DIR}/${WANDB_PROJECT}/sft_v3_128_v4_sep_final_v3_anet_mr \
    --num_train_epochs 3 \
    ...
    --sample_scheme "rand" \
    2> ${OUTP_DIR}/${WANDB_PROJECT}/log_128_sep_final_v2_anet_mr.err
